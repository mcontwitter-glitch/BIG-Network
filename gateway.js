...
http.createServer(async (req, res) => {
  ...
  if (req.url === '/' || req.url === '/index.html' || req.url === '/scan' || req.url === '/scan/' || req.url === '/wallet' || req.url === '/wallet.html' || req.url === '/node-setup' || req.url === '/node-setup/') {
    const page = req.url.startsWith('/scan') ? 'scan.html' : (req.url.startsWith('/wallet') ? 'wallet.html' : (req.url.startsWith('/node-setup') ? 'node-setup.html' : 'index.html'));
